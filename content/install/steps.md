...
- [Plex](https://plex.tv): I only recommend Plex to advanced users or people who need all the extra stuff it provides, because the interface and all the services might be a little overwhelming if this is your first time with a home server. I don't like it that much because it's always online, and it has more functionalities that I need to. Also, at least in YAMS, it's the hardest to configure. But if you want to share your media server to other people easily, Plex is the way to go! Jellyfin and Emby can share media to ouside your network, but they are a little more complicated to configure.
